...
public class DialogCreator {
    ...
    //Edited to use spinKit
    public static Dialog createLoadingDialog(Context context, String msg) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "ui_loading_view"), null);
        ConstraintLayout layout = v.findViewById(IdHelper.getViewID(context, "ui_loading_layout"));
...
//        mLoadText.setText(msg);
        final Dialog loadingDialog = new Dialog(context, R.style.SpinKitView_Large);
